...
-- my mech keyboards to bind a single key to `F18`, which fires all this
...
--   },
-- }
-- You can find the app.bundleID by running this command.
-- osascript -e 'id of app "BetterTouchTool"'
